            ...
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/encore-logo-icon.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light"><?php echo e(config('app.name', 'SakhiShakti')); ?></span>
                </a>
                <a href="javascript:;"
...
<?php /**PATH /home/sanmisha/@Projects/sakhishakti/resources/views/components/common/sidebar.blade.php ENDPATH**/ ?>