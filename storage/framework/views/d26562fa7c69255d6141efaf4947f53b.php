...
<?php $component->withAttributes([]); ?>
    <form method="POST" class="space-y-5" action="<?php echo e(route('register')); ?>">
        <?php echo csrf_field(); ?>

        <!-- Name -->
        <div>
            <label for="name"> Name </label>
            <input id="name" class="form-input" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="name" />
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Project\sakhi-shakti\resources\views/auth/register.blade.php ENDPATH**/ ?>