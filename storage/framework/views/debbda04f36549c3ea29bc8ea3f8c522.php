...
<?php $component->withAttributes([]); ?> 
    ...
    <div class="pt-5">
        <form action="<?php echo e(route('importProductExcel')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="panel">
...
<?php endif; ?>
                    ...
                    <div>
                        <a href="<?php echo e(asset('files/products.xls')); ?>" class="btn btn-success gap-2">
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\HP\Project\encore\resources\views/products/import.blade.php ENDPATH**/ ?>